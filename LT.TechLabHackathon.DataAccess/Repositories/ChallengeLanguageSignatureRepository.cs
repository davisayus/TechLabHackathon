...
{
    public class ChallengeLanguageSignatureRepository : GenericRepository<ChallengeLanguageSignature>, IChallengeLanguageSignatureRepository
    {
        public ChallengeLanguageSignatureRepository(SqlContext context) : base(context)
        {
        }
    }
}
