...
{
    public class ChallengeInputSetupParameterRepository : GenericRepository<ChallengeInputSetupParameter>, IChallengeInputSetupParameterRepository
    {
        public ChallengeInputSetupParameterRepository(SqlContext context) : base(context)
        {
        }
    }
}
