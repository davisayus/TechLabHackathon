...
{
    public class ChallengeExampleRepository : GenericRepository<ChallengeExample>, IChallengeExampleRepository
    {
        public ChallengeExampleRepository(SqlContext context) : base(context)
        {
        }
    }
}
