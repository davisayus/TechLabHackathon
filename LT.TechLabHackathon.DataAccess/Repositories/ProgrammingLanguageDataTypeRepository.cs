...
{
    public class ProgrammingLanguageDataTypeRepository : GenericRepository<ProgrammingLanguageDataType>, IProgrammingLanguageDataTypeRepository
    {
        public ProgrammingLanguageDataTypeRepository(SqlContext context) : base(context)
        {
        }
    }
}
